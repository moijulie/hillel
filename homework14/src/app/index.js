...
const obj = {
              firstName() {
                            ...
                            const validateFirstName = function (input) {
                                          return (
                                                        ...
                                                        input.length <
                                                                      MIN_NAME_VALUE ||
                                                        input.length > MAX_FIRST
                                          )
                            }
                            const firstName = STDIN.getInput(
                                          FIRST_NAME_MESSAGE,
                                          validateFirstName
                            )
              ...
              lastName() {
                            ...
                            const MAX_LAST = 20
                            const LAST_NAME_MESSAGE = `Enter your last name: min letters ${MIN_NAME_VALUE}, max letters ${MAX_LAST}`
                            const validateLastName = function (input) {
                                          return (
                                                        input === null ||
                                                        input.length <
                                                                      MIN_NAME_VALUE ||
                                                        input.length > MAX_LAST
                                          )
                            }
                            const lastName = STDIN.getInput(
                                          LAST_NAME_MESSAGE,
                                          validateLastName
                            )
              ...
              age() {
                            ...
                            const yearOfBirth = STDIN.getInput(
                                          BIRTH_YEAR_MESSAGE,
                                          validateYearOfBirth,
                                          coerceToNum
                            )
                            ...
                            const monthOfBirth = STDIN.getInput(
                                          BIRTH_MONTH_MESSAGE,
                            ...
                            let maxDayMonth = DATE.defineMaxDayMonth(
                                          yearOfBirth,
                                          monthOfBirth
                            )
                            ...
                            const dayOfBirth = STDIN.getInput(
                                          BIRTHDAY_MESSAGE,
                                          validateDayOfBirth,
                                          coerceToNum
                            )
